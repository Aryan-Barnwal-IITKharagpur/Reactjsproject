...
route.post("/send_update", function (req, res) {
  ...
  const mailOptions = {
    ...
    text: `Form has been updated for ${FormData.company_overview.name} `,
    attachment: {
      // use URL as an attachment
      filename: `${FormData.company_overview.name}.${FormData.job_detail.designation}.pdf`,
      path: `${FormData.pdf_downloadlink_student}`
