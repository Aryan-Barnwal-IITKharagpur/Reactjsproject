...
export default function SignInSide() {
  ...
  return (
    <ThemeProvider theme={theme}>
      <div className="">
        <Grid container component="main" className="shadow-lg rounded" style={{ height: "100vh" }, { borderRadius: 8 }}>
          <CssBaseline />
          <Grid
            item
            xs={false}
            ...
            md={7}
            sx={{
              backgroundImage: 'url(https://bhimeshagrawal.github.io/guest-house-iit-ism-dhanbad/images/homepageimage.jpg)',
          ...
          <Grid item xs={12} sm={8} md={5} component={Paper} elevation={6} square>
            ...
            >
              ...
              <Typography component="h3" variant="subtitle1" mb={4} align="center">
